...
export function NewsSection({ title, items, className, listClassName }: NewsSectionProps) {
  return (
    <section
      className={cn(
      ...
      <div className={cn(listClassName)}>
        {items.map((item) => (
          <a
            ...
            className="grid min-h-[48px] grid-cols-[1fr_124px] items-center gap-3 border-b border-surface-inset py-1 hover:bg-muted"
          >
